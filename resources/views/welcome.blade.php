...
<body class="bg-white min-h-screen flex flex-col">
    ...
    <main class="flex flex-col items-center flex-grow p-10">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-10">
            ...
            <!-- e-Arsip -->
            <a href="http://192.168.2.4/scan"
                class="w-36 h-36 bg-gray-50 shadow-md rounded-2xl flex flex-col items-center justify-center hover:shadow-xl hover:scale-105 transition transform">
                <img src="https://img.icons8.com/ios-filled/80/4caf50/opened-folder.png" alt="e-Arsip"
                    class="w-12 h-12 mb-3" />
                <span class="text-base text-gray-700 font-medium">Absen PKL</span>
            </a>

            <!-- Absensi Digital -->
            <a href="http://192.168.2.4:90 "
                class="w-36 h-36 bg-gray-50 shadow-md rounded-2xl flex flex-col items-center justify-center hover:shadow-xl hover:scale-105 transition transform">
                <img src="https://img.icons8.com/ios-filled/80/2196f3/attendance-mark.png" alt="Absensi"
                    class="w-12 h-12 mb-3" />
